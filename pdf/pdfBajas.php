...
function Header()
{
    ...
    $this->Cell(190,30,utf8_decode('COMPROBAMTE DE BAJAS'),0,0,'C');
...
$sql2="select *from lista_bajas  where id_bajas=$folio";
$query2=mysqli_query($con,$sql2);
$sql="call lista_bajas_articulos($folio);";
...
while ($resul=mysqli_fetch_array($query2))
{
...
$pdf->Ln(5);
$pdf->Cell(0,5,'Descripcion: '.$descripcion,0,1,'',0);
...
$pdf->Ln(-2);
$pdf->Cell(0,0,'Nombre y firma de quien hizo la baja',0,1,'C');
/*
$pdf->Cell(0,15,'____________________________________',0,1,'C');
$pdf->Ln(-2);
